...
{ 
    ...
    [SerializeField] private Image buy;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Cuttable"))
        {
         ...
         if(other.gameObject.tag == "Npc" || other.gameObject.tag == "Buyable") {
    ...
    {    
        ...
        if (other.CompareTag("Buyable"))
        {
            ...
            if (priceresultWood <= 0 && priceresultStone <= 0 && priceresultGold <= 0 && !data.IsBought && Input.GetKeyDown(KeyCode.E))
            {
         ...
         if (other.CompareTag("Npc"))
        {
            ...
            if (priceresultWood <= 0 && priceresultStone <= 0 && priceresultGold <= 0 && !data.IsBought && Input.GetKeyDown(KeyCode.E) )
            {
                ...
                buyableManager.BuyTheOtherObject();
            }
            else { }
